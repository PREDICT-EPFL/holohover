...
bool mocap_optitrack__msg__point_array_stamped__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mocap_optitrack.msg._point_array_stamped.PointArrayStamped", full_classname_dest, 58) == 0);
  }
  mocap_optitrack__msg__PointArrayStamped * ros_message = _ros_message;
  {  // header
...
PyObject * mocap_optitrack__msg__point_array_stamped__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("mocap_optitrack.msg._point_array_stamped");
