...
#include "mocap_optitrack/msg/detail/point_array_stamped__rosidl_typesupport_fastrtps_c.h"
...
#include "mocap_optitrack/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_mocap_optitrack
...
using _PointArrayStamped__ros_msg_type = mocap_optitrack__msg__PointArrayStamped;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mocap_optitrack
size_t get_serialized_size_mocap_optitrack__msg__PointArrayStamped(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _PointArrayStamped__ros_msg_type * ros_message = static_cast<const _PointArrayStamped__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _PointArrayStamped__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_mocap_optitrack__msg__PointArrayStamped(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mocap_optitrack
size_t max_serialized_size_mocap_optitrack__msg__PointArrayStamped(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _PointArrayStamped__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_mocap_optitrack__msg__PointArrayStamped(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mocap_optitrack, msg, PointArrayStamped)() {
