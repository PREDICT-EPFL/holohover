...
static const _Reading_type_support_symbol_names_t _Reading_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rokubimini_msgs, msg, Reading)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rokubimini_msgs, msg, Reading)),
  }
};
...
{
  return &::rokubimini_msgs::msg::rosidl_typesupport_cpp::Reading_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, rokubimini_msgs, msg, Reading)() {
  return get_message_type_support_handle<rokubimini_msgs::msg::Reading>();
}
