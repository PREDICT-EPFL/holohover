...
#include "holohover_msgs/msg/detail/attitude__rosidl_typesupport_fastrtps_c.h"
...
using _Attitude__ros_msg_type = holohover_msgs__msg__Attitude;
...
size_t get_serialized_size_holohover_msgs__msg__Attitude(
  const void * untyped_ros_message,
...
static uint32_t _Attitude__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_holohover_msgs__msg__Attitude(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_holohover_msgs
size_t max_serialized_size_holohover_msgs__msg__Attitude(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _Attitude__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_holohover_msgs__msg__Attitude(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, holohover_msgs, msg, Attitude)() {
