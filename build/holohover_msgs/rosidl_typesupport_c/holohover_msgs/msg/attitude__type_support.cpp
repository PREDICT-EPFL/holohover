...
static const _Attitude_type_support_symbol_names_t _Attitude_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, holohover_msgs, msg, Attitude)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, holohover_msgs, msg, Attitude)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, holohover_msgs, msg, Attitude)() {
  return &::holohover_msgs::msg::rosidl_typesupport_c::Attitude_message_type_support_handle;
}
