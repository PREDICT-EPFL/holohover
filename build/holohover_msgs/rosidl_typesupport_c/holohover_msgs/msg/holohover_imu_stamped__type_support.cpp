...
static const _HolohoverIMUStamped_type_support_symbol_names_t _HolohoverIMUStamped_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, holohover_msgs, msg, HolohoverIMUStamped)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, holohover_msgs, msg, HolohoverIMUStamped)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, holohover_msgs, msg, HolohoverIMUStamped)() {
  return &::holohover_msgs::msg::rosidl_typesupport_c::HolohoverIMUStamped_message_type_support_handle;
}
