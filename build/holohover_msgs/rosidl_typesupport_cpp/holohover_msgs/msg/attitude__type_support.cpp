...
static const _Attitude_type_support_symbol_names_t _Attitude_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, holohover_msgs, msg, Attitude)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, holohover_msgs, msg, Attitude)),
  }
};
...
{
  return &::holohover_msgs::msg::rosidl_typesupport_cpp::Attitude_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, holohover_msgs, msg, Attitude)() {
  return get_message_type_support_handle<holohover_msgs::msg::Attitude>();
}
