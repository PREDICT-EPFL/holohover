...
HolohoverProps load_holohover_pros(rclcpp::Node &node)
{
    ...
    if (node.get_parameter("propeller_pair_gap_distance", props.propeller_pair_gap_distance) &&
        ...
        node.get_parameter("motor_pos_a_1", props.learned_motor_vec_a_1) &&
        node.get_parameter("motor_pos_b_1", props.learned_motor_vec_a_2) &&
        node.get_parameter("motor_pos_b_2", props.learned_motor_vec_b_1) &&
        node.get_parameter("motor_pos_c_1", props.learned_motor_vec_b_2) &&
        node.get_parameter("motor_pos_c_2", props.learned_motor_vec_c_1) &&
        node.get_parameter("motor_pos_c_2", props.learned_motor_vec_c_2)
        )
    {
